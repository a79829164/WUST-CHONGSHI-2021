#!/home/nvidia/miniforge3/envs/yolov5/bin/python3
# coding: utf-8
...
weights = '/home/nvidia/wust_ws/src/my_roborts_camera/src/weights/rm2021.pt'
...
def detect(color_frame, aligned_depth_frame, color_intrin_part, model, mode=1):
    ...
    # Apply NMS
    pred = non_max_suppression(pred, 0.3, 0.3, None, agnostic=False)
